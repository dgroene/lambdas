...
aws lambda create-function --function-name $lambda --role arn:aws:iam::156163025211:role/lambda_basic_execution --runtime nodejs8.10 --handler index.handler --zip-file fileb://archive.zip --publish --profile default
...
aws lambda update-function-code --function-name $lambda --zip-file fileb://archive.zip --publish --profile default
